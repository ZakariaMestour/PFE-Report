...
[Insert screenshot of the SCF dashboard with role-based sidebar]
...
[Insert screenshot of the Master Setup tabs]
...
[Insert screenshot of the Program Configuration wizard]
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth, keepaspectratio]{images/ch4_invoice_upload_flow.png}
...
[Insert screenshot of Invoice Upload validation table]
...
The finance disbursement flow is implemented as a six-step wizard inside \texttt{FinanceDisbursementModal}. The panes are \texttt{ProgramProductSelectionPane}, \texttt{InvoiceSelectionPane}, \texttt{FinanceDetailsPane}, \texttt{AccountingEntriesPane}, \texttt{RepaymentDetailsPane}, and \texttt{ReviewSubmitPane}. Figure~\ref{fig:ch4_finance_disbursement_wizard} presents the sequence.
...
The first pane selects the program and product context. The invoice pane loads eligible invoices and allows the user to select which invoices will be financed. The finance details pane captures terms and presents fee breakdown information. Accounting entries are displayed as debit and credit lines. The repayment pane configures schedule-related details. The final pane reviews the full request before submission.

[Insert screenshot of Finance Disbursement wizard]
