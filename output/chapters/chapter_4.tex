...
The finance disbursement flow is implemented as a six-step wizard inside \texttt{FinanceDisbursementModal}. The panes are \texttt{ProgramProductSelectionPane}, \texttt{InvoiceSelectionPane}, \texttt{FinanceDetailsPane}, \texttt{RepaymentDetailsPane}, \texttt{AccountingEntriesPane}, and \texttt{ReviewSubmitPane}. Figure~\ref{fig:ch4_finance_disbursement_wizard} presents the earlier generated sequence, while Figure~\ref{fig:ch4_manual_disbursement_screen} shows the current platform screen.
