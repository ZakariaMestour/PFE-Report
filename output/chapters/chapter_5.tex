...
[Insert formal UML state machine diagram for Disbursement lifecycle: initial, INITIATED, PENDING\_CONFIRMATION, SUCCESS, FAILED, and transition labels]
...
[Insert corrected UML sequence diagram for manual disbursement with Payment Gateway, 202 Accepted, webhook callback, HMAC validation, Kafka topic \texttt{payment.callback}, and \texttt{DisbursementEventConsumer}]
